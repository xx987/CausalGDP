...
def train_diffusion_qlearning_online(env, num_episodes, batch_size, lr=3e-4, alpha_policy=0.5):
    ...
    for ep in range(num_episodes):
        ...
        while not done:
            ...
            best_rewards = sorted(episode_rewards)[-10:]  # top 10 episodes
...
if __name__ == "__main__":
    ...
    rewards = train_diffusion_qlearning_online(env, num_episodes=3000, batch_size=256, lr=3e-4, alpha_policy=5)
